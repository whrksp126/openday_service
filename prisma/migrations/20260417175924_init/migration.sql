...
-- AddForeignKey
ALTER TABLE `Template` ADD CONSTRAINT `Template_subcategoryId_fkey` FOREIGN KEY (`subcategoryId`) REFERENCES `Subcategory`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
